...
////VOTER SECTION
    ...
    function voterRight(address _address , string memory _name , string memory _image , string memory _ipfs) public{
        ...
        require(votingOrganizer==msg.sender,"Only Organizer can create the voter");
    ...
    function voterData(address _address) public view returns(uint256 , string memory , string memory , address ,
